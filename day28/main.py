...
#Start - Button
start_button = tk.Button(window, text="Start", font="Verdana", highlightthickness=0, command=start_timer)
start_button.grid(column=0, row=2)

#Reset - Button
reset_button = tk.Button(window, text="Reset", font="Verdana", highlightthickness=0,command=reset_timer)
reset_button.grid(column=2, row=2)

#checker - Label
checker_label = tk.Label(window, fg=GREEN, bg=YELLOW)
